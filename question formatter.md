...
### 🅰️ MCQ (বহু নির্বাচনী প্রশ্ন)
1. [ধাপ ১: প্রশ্ন নম্বর অটো-অ্যালাইন করা (Hanging Indent)](#mcq-ধাপ-১-প্রশ্ন-নম্বর-অটো-অ্যালাইন-করা-hanging-indent)
2. [ধাপ ৮: ৪টি পৃথক লাইনে থাকা অপশন → ২ লাইনে](#mcq-ধাপ-৮-৪টি-পৃথক-লাইনে-থাকা-অপশনগুলোকে-২-লাইনে-নিয়ে-আসা)
3. [ধাপ ৯: ৪টি অপশন → ৪টি পৃথক লাইনে](#mcq-ধাপ-৯-৪টি-অপশনকে-৪টি-পৃথক-লাইনে-সাজানো)
4. [ধাপ ১৪: রোমান সংখ্যা ফরম্যাটিং (পদ্ধতি ক)](#mcq-ধাপ-১৪-রোমান-সংখ্যা-ফরম্যাটিং-পদ্ধতি-ক)
5. [ধাপ ৩: অপশনের ব্র্যাকেট মুছে ফন্ট সেট](#mcq-ধাপ-৩-অপশনের-ব্র্যাকেট-মুছে-নির্দিষ্ট-ফন্ট-সেট-করা)
6. [ধাপ ২: ৪টি অপশনকে ২ লাইনে সাজানো](#mcq-ধাপ-২-৪টি-অপশনকে-২-লাইনে-সাজানো)
7. [ধাপ ৪: অপশনগুলোতে অটো ইনডেন্টেশন](#mcq-ধাপ-৪-অপশনগুলোতে-অটো-ইনডেন্টেশন)
8. [ধাপ ১০: অপশন ব্র্যাকেটের ভেতরের স্পেস দূর](#mcq-ধাপ-১০-অপশন-ব্র্যাকেটের-ভেতরের-অপ্রয়োজনীয়-স্পেস-দূর-করা)
9. [ধাপ ১১: ব্র্যাকেটহীন অপশন → ব্র্যাকেটে](#mcq-ধাপ-১১-ব্র্যাকেটহীন-অপশনগুলোকে-ব্র্যাকেটে-রূপান্তর-করা)
10. [ধাপ ১৩: অপশনের বর্ণে ডট/ব্র্যাকেট যোগ](#mcq-ধাপ-১৩-অপশনের-বর্ণে-ডট-বা-ব্র্যাকেট-যোগ-করা)

### 🅱️ CQ (সৃজনশীল প্রশ্ন)
1. [ধাপ ১: প্রশ্ন নম্বর অটো-অ্যালাইন করা (Hanging Indent)](#cq-ধাপ-১-প্রশ্ন-নম্বর-অটো-অ্যালাইন-করা-hanging-indent)
2. [ধাপ ৩: অপশনের ব্র্যাকেট মুছে ফন্ট সেট](#cq-ধাপ-৩-অপশনের-ব্র্যাকেট-মুছে-নির্দিষ্ট-ফন্ট-সেট-করা)
3. [ধাপ ৬: পূর্ণমান নম্বর ডানে পাঠানো (Right Tab)](#cq-ধাপ-৬-শেষের-পূর্ণমান-নম্বরগুলোকে-ডানে-পাঠানো-right-tab)
4. [ধাপ ৫: সংখ্যা ও দাড়ির পর ট্যাব বজায়](#cq-ধাপ-৫-সংখ্যা-ও-দাড়ির-পর-ট্যাব-বজায়-রাখা)
5. [ধাপ ৭: বন্ধনীতে নম্বর ডানে সরানো (Right Tab)](#cq-ধাপ-৭-প্রশ্নের-শেষে-বন্ধনীতে-থাকা-নম্বর-ডানে-সরানো-right-tab)
6. [ধাপ ১২: অতিরিক্ত স্পেস দূর করা](#cq-ধাপ-১২-লেখার-ভেতরের-অতিরিক্ত-স্পেস-দূর-করা)

---

## 🅰️ MCQ (বহু নির্বাচনী প্রশ্ন) ফরম্যাটিং

### MCQ ধাপ ১: ১ থেকে ৩০ পর্যন্ত প্রশ্ন নম্বর অটো-অ্যালাইন করা (Hanging Indent)
...
### MCQ ধাপ ৮: ৪টি পৃথক লাইনে থাকা অপশনগুলোকে ২ লাইনে নিয়ে আসা (ক-খ এবং গ-ঘ)
...
#### উদাহরণ (ছবি):
* **আগে (Before):**
  ![image_1781707649947_0](files/image_1781707649947_0.png)
* **পরে (After):**
  ![image_1781707608306_0](files/image_1781707608306_0.png)

#### পদ্ধতি গ: ব্র্যাকেটবিহীন অপশন ২ লাইনে সাজানো
যদি অপশনগুলোর চারপাশে ব্র্যাকেট না থাকে (শুধু ক, খ, গ, ঘ), তাহলে নিচের প্যাটার্ন ব্যবহার করুন:
...
#### উদাহরণ (ছবি):
* **আগে (Before):**
  ![image_1781699253965_0](files/image_1781699253965_0.png)
* **পরে (After):**
  ![image_1781699099790_0](files/image_1781699099790_0.png)

---

### MCQ ধাপ ৯: ৪টি অপশনকে ৪টি পৃথক লাইনে (নিচে নিচে) সাজানো
...
### MCQ ধাপ ১৪: রোমান সংখ্যা ফরম্যাটিং (পদ্ধতি ক)
...
### MCQ ধাপ ৩: অপশনের ব্র্যাকেট মুছে নির্দিষ্ট ফন্ট সেট করা
...
#### উদাহরণ (ছবি):
* **আগে (Before):**
  ![image_1781709506763_0](files/image_1781709506763_0.png)
* **পরে (After):**
  ![image_1781709525659_0](files/image_1781709525659_0.png)

#### আরও একটি পদ্ধতি: শুধু ক্লোজিং ব্র্যাকেট সরানো
যদি অপশনের পরে শুধু ক্লোজিং ব্র্যাকেট থাকে (যেমন: `ক)`) এবং ওপেনিং ব্র্যাকেট না থাকে:
...
#### উদাহরণ (ছবি):
* **আগে (Before):**
  ![image_1781699058623_0](files/image_1781699058623_0.png)
* **পরে (After):**
  ![onlinenotepad_io_image](files/onlinenotepad_io_image.png)

---

### MCQ ধাপ ২: ৪টি অপশনকে ২ লাইনে সাজানো (ক-খ এবং গ-ঘ)
...
#### উদাহরণ (ছবি):
* **আগে (Before):**
  ![image_1781709104779_0](files/image_1781709104779_0.png)
* **পরে (After):**
  ![image_1781709127547_0](files/image_1781709127547_0.png)
...
### MCQ ধাপ ৪: অপশনগুলোতে অটো ইনডেন্টেশন (স্পেসকে ট্যাবে রূপান্তর)
...
#### উদাহরণ (ছবি):
* **আগে (Before):**
  ![image_1781701493992_0](files/image_1781701493992_0.png)
* **পরে (After):**
  ![image_1781701476135_0](files/image_1781701476135_0.png)

#### পদ্ধতি ছ: Tab Stop Position পুনরায় সেট করা
যদি আগে থেকে Tab দিয়ে অপশন আলাদা করা থাকে তাহলে Tab Stop Position পুনরায় সেট করার নিয়ম:
...
1. নিচের তথ্যগুলো দিন:
   ...
   * **Replace with:**
     ...
     \1^t
     ```
2. **Replace with** বক্সে কার্সার রাখুন।
3. নিচে থাকা **Format** > **Tab…**-এ গিয়ে আপনার কাঙ্ক্ষিত Position এ stop tab সিলেক্ট করে **OK** দিন।
4. সবশেষে **Replace All** বাটনে ক্লিক করুন।

#### উদাহরণ (ছবি):
* **আগে (Before):**
  ![image_1781713297630_0](files/image_1781713297630_0.png)
* **পরে (After):**
  ![image_1781713317049_0](files/image_1781713317049_0.png)

---

### MCQ ধাপ ১০: অপশন ব্র্যাকেটের ভেতরের অপ্রয়োজনীয় স্পেস দূর করা
...
### MCQ ধাপ ১১: ব্র্যাকেটহীন অপশনগুলোকে ব্র্যাকেটে রূপান্তর করা
...
### MCQ ধাপ ১৩: অপশনের বর্ণে ডট বা ব্র্যাকেট যোগ করা (পৃথক লাইনে)
...
#### উদাহরণ (ছবি):
* **আগে (Before):**
  ![image_1781699650622_0](files/image_1781699650622_0.png)
* **পরে (After):**
  ![image_1781699664534_0](files/image_1781699664534_0.png)

---

## 🅱️ CQ (সৃজনশীল প্রশ্ন) ফরম্যাটিং

### CQ ধাপ ১: ১ থেকে ৩০ পর্যন্ত প্রশ্ন নম্বর অটো-অ্যালাইন করা (Hanging Indent)
প্রশ্ন নম্বরের পর দাড়ি ও স্পেস থাকলে তা স্বয়ংক্রিয়ভাবে অ্যালাইন করার নিয়ম:
...
### CQ ধাপ ৩: অপশনের ব্র্যাকেট মুছে নির্দিষ্ট ফন্ট সেট করা
অপশনগুলোর চারপাশের ব্র্যাকেটগুলো যেমন: `(ক)` থেকে `ক` মুছে ফেলে ফন্ট (যেমন: `NesarulOMR`) সেট করার নিয়ম:
...
### CQ ধাপ ৬: শেষের পূর্ণমান নম্বরগুলোকে ডানে পাঠানো (Right Tab)
...
### CQ ধাপ ৫: সংখ্যা ও দাড়ির পর ট্যাব বজায় রাখা
...
### CQ ধাপ ৭: প্রশ্নের শেষে বন্ধনীতে থাকা নম্বর ডানে সরানো (Right Tab)
...
### CQ ধাপ ১২: লেখার ভেতরের অতিরিক্ত স্পেস দূর করা
